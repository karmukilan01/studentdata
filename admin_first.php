...
<center>
	...
	<a href="index.php"><button style="background-color:pink; color:darkgreen; font-weight: bold; cursor: pointer; width: 200px;height: 40px" >TUTOR DATABASE</button></a><br><br>
